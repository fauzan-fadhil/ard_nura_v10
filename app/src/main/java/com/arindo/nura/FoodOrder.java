...
public class FoodOrder extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.content_foodorder);
       ...
       // getMaps();
        ...
        txtdest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(FoodOrder.this, "error", Toast.LENGTH_LONG).show();
                getCekResto();
            }
        });
    ...
    public void SetListViewAdapter(ArrayList<HashMap<String, String>> restolist) {
        adapter = new LazyAdapterRestoMenu2(this, restolist, 1);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        gps = new GPSTracker(FoodOrder.this);
    ...
    public class TaskOrder extends AsyncTask<String, Integer, String[]> {
        String[] result = null;
        String statuskomplit = null;
        final Dialog dialog = new Dialog(FoodOrder.this, android.R.style.Theme_Translucent);
        @Override
        protected void onPreExecute() {
            super.onPreExecute();
        ...
        protected String[] doInBackground(String... value) {
            try {
                ...
                post.add(new BasicNameValuePair("restoid",restoid));
                post.add(new BasicNameValuePair("distance",distanceprice[0]));
                post.add(new BasicNameValuePair("distanceprice",distanceprice[1]));
