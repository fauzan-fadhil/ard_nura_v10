...
public class LazyAdapterRestoMenuNonKurir extends BaseAdapter {
    ...
    public LazyAdapterRestoMenuNonKurir(Activity a, ArrayList<HashMap<String, String>> d, int p){
        activity = a;
        data = d;
        param = p;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.minus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(param==1){
                    FoodOrderNonKurir onReAmmount = new FoodOrderNonKurir();
