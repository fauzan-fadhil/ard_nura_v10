...
public class LazyAdapterRestoMenu2 extends BaseAdapter {
    ...
    public LazyAdapterRestoMenu2(Activity a, ArrayList<HashMap<String, String>> d, int p){
        activity = a;
        data = d;
        param = p;
    ...
    public class ViewHolder{
        ...
        com.arindo.nura.NumberPicker numpicker;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.row_foodrestomenu, null);
            ...
            holder.numpicker = (com.arindo.nura.NumberPicker) convertView.findViewById(R.id.number_picker);
        ...
        final String countadd = String.valueOf(selectQty.setQty());//listsendoption.get(FoodRestoMenu.TAG_ADD);
